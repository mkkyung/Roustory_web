...
//추천여행
export const recommendDB = () => axios.get(`/recommend/recommendlist`);
//홈 후기
export const popularDB = () => axios.get(`/recommend/recommendlist`);
//일정짜기
export const tourDB = () => axios.get(`/tourist/tourist`)


// export const getProjectImage = (num) => axios.get(`api/Image/`, { params:{flag:num ,fields:'id,flag,file'}} )
...
export const getReviewList = ({order}) => axios.post(`/review/reviewlist`, {order});
