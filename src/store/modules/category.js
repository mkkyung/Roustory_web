    ...
    reviewData: [
        {
            ...
            selected: true,
            content: [
                { user: 'RouStory', image: 'https://source.unsplash.com/250x300/?peach', title: '6.25', like: 1, isLike: false, selected:false, event_cd:'' },
                { user: 'RouStory', image: 'https://source.unsplash.com/250x300/?banana', title: '일제 강점기', like: 2, isLike: false, selected:false, event_cd:'' },
                { user: 'RouStory', image: 'https://source.unsplash.com/250x300/?watermelon', title: '4.3', like: 3, isLike: false, selected:false, event_cd:'' },
                { user: 'RouStory', image: 'https://source.unsplash.com/250x300/?watermelon', title: '4.3', like: 14, isLike: false, selected:false, event_cd:'' },
                { user: 'RouStory', image: 'https://source.unsplash.com/250x300/?watermelon', title: '4.3', like: 5, isLike: false, selected:false, event_cd:'' },
                { user: 'RouStory', image: 'https://source.unsplash.com/250x300/?watermelon', title: '4.3', like: 6, isLike: false, selected:false, event_cd:'' },
                { user: 'RouStory', image: 'https://source.unsplash.com/250x300/?watermelon', title: '4.3', like: 7, isLike: false, selected:false, event_cd:'' },
                { user: 'RouStory', image: 'https://source.unsplash.com/250x300/?watermelon', title: '4.3', like: 8, isLike: false, selected:false, event_cd:'' },
            ]
        },
        {
            tag: 'review',
